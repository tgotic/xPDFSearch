...
typedef int (*TextOutputFunc)(void *stream, const char *text, int len);
...
public:
  ...
  TextOutputDev(const TextOutputDev&) = delete;
  TextOutputDev& operator=(const TextOutputDev&) = delete;
