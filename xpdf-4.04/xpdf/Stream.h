...
public:
  ...
  virtual int getBlock(char *buf, int size);
...
public:
  ...
  virtual ~MemStream();
  virtual Stream *copy();
  virtual Stream *makeSubStream(GFileOffset startA, GBool limited,
				GFileOffset lengthA, Object *dictA);
...
public:
  ...
  LZWStream(Stream *strA, int predictor, int columns, int colors,
	    int bits, int earlyA);
  LZWStream(const LZWStream&) = delete;
  LZWStream& operator=(const LZWStream&) = delete;
...
public:
  ...
  FlateStream(Stream *strA, int predictor, int columns,
	      int colors, int bits);
  FlateStream(const FlateStream&) = delete;
  FlateStream& operator=(const FlateStream&) = delete;
  virtual ~FlateStream();
  virtual Stream *copy();
